...
class AgenticRagInstructions(BaseModel):
    type: Literal["agentic_rag"] = "agentic_rag"

    def make_system_prompt(self) -> str:
        # The full tool-use system prompt lives in unmute/agentic_rag_tools.py
        # (SYSTEM_PROMPT) since it needs to stay in sync with the TOOLS
        # definitions there. Imported lazily to avoid a circular import
        # (agentic_rag_tools doesn't depend on this module).
        from unmute.agentic_rag_tools import SYSTEM_PROMPT
